...
let amountUnfundedGames = GAMES_JSON.filter (game =>
    game.pledged < game.goal).length;


// create a string that explains the number of unfunded games using the ternary operator
let unfundedGamesStr = `A total of $${totalAmountRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${amountUnfundedGames} games remain unfunded. We need your help to fund these amazing games!`;
